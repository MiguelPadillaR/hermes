...
def test_get_knowledge_base_seeding(
    mock_listdir, mock_chunk_doc, mock_chroma_client_cls
):
    """
    ...
    doc_1 = Document(
        page_content="Core medical procedure directions here.", metadata={}
    )
    doc_2 = Document(
        page_content="This is a segment containing bibliografia references.",
        metadata={},
    )
